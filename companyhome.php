...
<div class="blockquote text-center  ">
    <font face = "Sans-serif" size = "15">Welcome to Jobs4U.com</font>
</div>

<div class="container text-center">
  <img src="complogo (1).jpeg" alt="" class="rounded-circle " style="max-width:100%;max-height:100%">
  <br><br>

  <div class="">
    <p face = "Sans-serif" style="font-size:20px">Want to hire Creative , Experienced , Skilled , trained , Well you are at the Right Place.You can post your jobs in our website and receive applications.Select the suitable candidate from the applications and shortlist the by viewing their resumes .
    </p>
  </div>
