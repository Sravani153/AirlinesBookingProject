...
{
  echo '<script>alert("Login Unsuccessful Please Check your adminpassword and admin id");
</script>'
;
}
  }
    ...
    <div class="form-group row">
      <label for="adminpassword" class="col-sm-2 col-form-label" >Enter your password</label>
      <div class="col-sm-9">
